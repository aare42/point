...
const translations = {
  en: {
    ...
    'landing.platform_title': 'Point Platform',
    'landing.hero_subtitle': 'Educational Platform Built Around Knowledge Graph',
    'landing.hero_description': 'Create your learning trajectory, track progress, and build knowledge portfolio. Connect topics across domains through prerequisite relationships.',
    'landing.start_journey': 'Start Your Learning Journey',
    'landing.get_started': 'Get Started with Google',
    'landing.how_platform_works': 'How Point Platform Works',
    'landing.platform_explanation': 'We connect learning through a knowledge graph where topics are linked by prerequisite relationships. Students set goals, educators create courses, and employers find talent - all unified by skills and knowledge.',
    'landing.knowledge_graph_concept': 'Knowledge Graph',
    'landing.knowledge_graph_desc': 'Topics are connected by prerequisite relationships, creating a web of knowledge that spans different domains and disciplines.',
    'landing.unified_topics': 'Unified by Topics',
    'landing.unified_topics_desc': 'Student goals, educator courses, and employer vacancies are all sets of topics, creating natural connections and pathways.',
    'landing.knowledge_portfolio': 'Knowledge Portfolio',
    'landing.knowledge_portfolio_desc': 'Track your learning progress and build a comprehensive portfolio that shows your complete skill landscape to potential employers.',
    'landing.three_ways_title': 'Three Ways to Use Point Platform',
    'landing.three_ways_subtitle': 'Whether you\'re learning, teaching, or hiring - Point Platform adapts to your role',
    'landing.for_students': 'For Students',
    'landing.students_description': 'Set learning goals, track your progress through the knowledge graph, and build a comprehensive skill portfolio.',
    'landing.set_learning_goals': 'Set Learning Goals',
    'landing.set_goals_desc': 'Define your learning objectives and track progress',
    'landing.find_courses': 'Find Courses',
    'landing.find_courses_desc': 'Discover courses that match your goals and skill gaps',
    'landing.explore_careers': 'Explore Careers',
    'landing.explore_careers_desc': 'See job requirements and create learning goals from vacancies',
    'landing.for_educators': 'For Educators',
    'landing.educators_description': 'Create courses, validate student progress, and connect your teaching to the broader knowledge ecosystem.',
    'landing.create_courses': 'Create Courses',
    'landing.create_courses_desc': 'Build courses around specific topics and skill sets',
    'landing.validate_learning': 'Validate Learning',
    'landing.validate_learning_desc': 'Assess and validate student knowledge and skills',
    'landing.track_students': 'Track Students',
    'landing.track_students_desc': 'Monitor student progress and provide guidance',
    'landing.for_employers': 'For Employers',
    'landing.employers_description': 'Post skill-based job requirements, discover candidates through their learning portfolios, and see the complete skill picture.',
    'landing.post_vacancies': 'Post Vacancies',
    'landing.post_vacancies_desc': 'Define job requirements as sets of topics and skills',
    'landing.find_talent': 'Find Talent',
    'landing.find_talent_desc': 'Discover candidates based on their learning goals and progress',
    'landing.skill_mapping': 'Skill Mapping',
    'landing.skill_mapping_desc': 'See complete knowledge landscape of potential hires',
    'landing.ready_start_title': 'Ready to Start Your Learning Journey?',
    'landing.ready_start_subtitle': 'Join Point Platform and experience education through the lens of connected knowledge',
  },
  uk: {
    // Navigation
    ...
    // New Landing Page Content
    'landing.platform_title': 'Платформа Point',
    'landing.hero_subtitle': 'Освітня платформа, побудована на графі знань',
    'landing.hero_description': 'Створюйте свою навчальну траєкторію, відстежуйте прогрес та будуйте портфоліо знань. Поєднуйте теми різних сфер через зв\'язки передумов.',
    'landing.start_journey': 'Розпочніть свою навчальну подорож',
    'landing.get_started': 'Почати з Google',
    'landing.how_platform_works': 'Як працює платформа Point',
    'landing.platform_explanation': 'Ми поєднуємо навчання через граф знань, де теми пов\'язані відношеннями передумов. Студенти ставлять цілі, викладачі створюють курси, а роботодавці знаходять таланти - все об\'єднано навичками та знаннями.',
    'landing.knowledge_graph_concept': 'Граф знань',
    'landing.knowledge_graph_desc': 'Теми поєднані відношеннями передумов, створюючи мережу знань, що охоплює різні домени та дисципліни.',
    'landing.unified_topics': 'Об\'єднані темами',
    'landing.unified_topics_desc': 'Цілі студентів, курси викладачів та вакансії роботодавців - це все набори тем, що створюють природні зв\'язки та шляхи.',
    'landing.knowledge_portfolio': 'Портфоліо знань',
    'landing.knowledge_portfolio_desc': 'Відстежуйте свій навчальний прогрес та створюйте комплексне портфоліо, яке показує потенційним роботодавцям повну картину ваших навичок.',
    'landing.three_ways_title': 'Три способи використання платформи Point',
    'landing.three_ways_subtitle': 'Чи ви навчаєтеся, викладаєте або наймаєте - платформа Point адаптується до вашої ролі',
    'landing.for_students': 'Для студентів',
    'landing.students_description': 'Встановлюйте навчальні цілі, відстежуйте свій прогрес через граф знань та будуйте комплексне портфоліо навичок.',
    'landing.set_learning_goals': 'Встановлення навчальних цілей',
    'landing.set_goals_desc': 'Визначте свої навчальні цілі та відстежуйте прогрес',
    'landing.find_courses': 'Пошук курсів',
    'landing.find_courses_desc': 'Знаходьте курси, що відповідають вашим цілям та прогалинам у навичках',
    'landing.explore_careers': 'Дослідження кар\'єри',
    'landing.explore_careers_desc': 'Переглядайте вимоги до роботи та створюйте навчальні цілі з вакансій',
    'landing.for_educators': 'Для викладачів',
    'landing.educators_description': 'Створюйте курси, підтверджуйте прогрес студентів та поєднуйте своє викладання з більш широкою екосистемою знань.',
    'landing.create_courses': 'Створення курсів',
    'landing.create_courses_desc': 'Будуйте курси навколо конкретних тем та наборів навичок',
    'landing.validate_learning': 'Підтвердження навчання',
    'landing.validate_learning_desc': 'Оцінюйте та підтверджуйте знання та навички студентів',
    'landing.track_students': 'Відстеження студентів',
    'landing.track_students_desc': 'Моніторьте прогрес студентів та надавайте керівництво',
    'landing.for_employers': 'Для роботодавців',
    'landing.employers_description': 'Публікуйте вакансії на основі навичок, знаходьте кандидатів через їхні навчальні портфоліо та бачте повну картину навичок.',
    'landing.post_vacancies': 'Публікація вакансій',
    'landing.post_vacancies_desc': 'Визначайте вимоги до роботи як набори тем та навичок',
    'landing.find_talent': 'Пошук талантів',
    'landing.find_talent_desc': 'Знаходьте кандидатів на основі їхніх навчальних цілей та прогресу',
    'landing.skill_mapping': 'Картування навичок',
    'landing.skill_mapping_desc': 'Бачте повний ландшафт знань потенційних співробітників',
    'landing.ready_start_title': 'Готові розпочати свою навчальну подорож?',
    'landing.ready_start_subtitle': 'Приєднуйтеся до платформи Point і відчуйте освіту через призму взаємопов\'язаних знань',
  }
}
