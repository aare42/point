...
export default function Graph5Page() {
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-4xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-2">
                🧠 Approach 5: Dagre-style Layout
              </h1>
              <p className="text-gray-600">
                Topological sorting into dependency layers - sophisticated hierarchical approach
              </p>
            </div>
            ...
            <div className="flex-1 bg-white rounded-2xl shadow-xl p-6 border border-gray-200">
              <div className="mb-4 flex items-center justify-between">
                <div className="text-sm text-gray-500">
                  Dagre-style topological layout • Clean dependency layers • All {graphData.links.length} arrows should be visible
                </div>
                  ...
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-gray-500 capitalize">
                        {selectedNode.type?.toLowerCase()} • Dependency Layer
                      </div>
                    </div>
                  </div>
                </div>
                            ...
                            {topicData.prerequisites.map(prereq => (
                              ...
                              >
                                ...
                                <div className="flex-1">
                                  ...
                                  <div className="text-xs text-gray-500">Previous layer</div>
                                </div>
                              </div>
                            ))}
                          </div>
                        ) : (
                          <p className="text-sm text-gray-500 italic">No prerequisites required • Root layer</p>
                        )}
                      </div>
                    )
                  })()}
