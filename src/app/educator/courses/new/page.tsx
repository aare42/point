        ...
        <div className="mb-8">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600">Design a learning path with selected topics</p>
            </div>
          </div>
        </div>
              ...
              <div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  >
                    <span>🔒</span>
                    <span>Private</span>
                    {!isPublic && <span className="text-indigo-600">✓</span>}
                  </button>
                  <button
                    type="button"
                  ...
                  >
                    <span>🌍</span>
                    <span>Public</span>
                    {isPublic && <span className="text-green-600">✓</span>}
                  </button>
                </div>
                <p className="text-sm text-gray-500 mt-2">
                  {isPublic 
                    ? 'Your course will be visible to all users and appear in the public courses directory'
                    : 'Your course will only be visible to you and students you directly invite'}
                </p>
              </div>
            </div>
          </div>
