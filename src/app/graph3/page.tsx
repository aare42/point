      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">
                Concentric circles by topic type - Theory (inner), Practice (middle), Projects (outer)
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
            ...
            <div className="text-sm text-gray-600">📚 Theory (Inner)</div>
          </div>
          <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
            ...
            <div className="flex-1 bg-white rounded-2xl shadow-xl p-6 border border-gray-200">
              <div className="mb-4 flex items-center justify-between">
                <div className="text-sm text-gray-500">
                  Circular layout with type clustering • Curved arrows • All {graphData.links.length} arrows should be visible
                </div>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-gray-500 capitalize">
                        {selectedNode.type?.toLowerCase()} • {
                          selectedNode.type === 'THEORY' ? 'Inner Circle' :
                          selectedNode.type === 'PRACTICE' ? 'Middle Circle' : 'Outer Circle'
                        }
                      </div>
                    </div>
                  </div>
                              ...
                              >
                                ...
                                <div className="flex-1">
                                  ...
                                  <div className="text-xs text-gray-500">
                                    {prereq.prerequisite.type === 'THEORY' ? 'Inner Circle' :
                                     prereq.prerequisite.type === 'PRACTICE' ? 'Middle Circle' : 'Outer Circle'}
                                  </div>
                                </div>
                              </div>
                            ))}
