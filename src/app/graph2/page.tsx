          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">
                Top-down levels based on prerequisite depth - clear learning progression
              </p>
            </div>
            ...
            <div className="flex-1 bg-white rounded-2xl shadow-xl p-6 border border-gray-200">
              <div className="mb-4 flex items-center justify-between">
                <div className="text-sm text-gray-500">
                  Hierarchical layout • Prerequisites flow top to bottom • All {graphData.links.length} arrows should be visible
                </div>
